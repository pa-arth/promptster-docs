...
<Steps>
  ...
  <Step title="Candidates complete the assessment">
    ...
    This configures their AI tool — Claude Code, Codex, or Cursor — to capture session telemetry automatically. The candidate works normally and runs `promptster done` to submit when finished.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Manage assessments" icon="folder" href="/reviewers/api/assessments/create">
    Full reference for assessment and key management.
  </Card>
  <Card title="API reference" icon="code" href="/reviewers/api/assessments/create">
